...
ALTER TABLE Localidades  WITH CHECK ADD FOREIGN KEY(IdCiudad)
...
ALTER TABLE Vehiculo  WITH CHECK ADD FOREIGN KEY(ClaseID)
REFERENCES Clase(ID)
GO

ALTER TABLE Vehiculo  WITH CHECK ADD FOREIGN KEY(TamañoID)
REFERENCES Tamaño(ID)
GO

ALTER TABLE Vehiculo  WITH CHECK ADD FOREIGN KEY(TrasmisionID)
REFERENCES Trasmision(ID)
GO
...
ALTER TABLE VehiculosLocalidad  WITH CHECK ADD FOREIGN KEY(LocalidadID)
REFERENCES Localidades(ID)
GO

ALTER TABLE VehiculosLocalidad  WITH CHECK ADD FOREIGN KEY(VehiculoID)
...
ALTER TABLE LocalidadesCovenio  WITH CHECK ADD FOREIGN KEY(LocalidadID)
REFERENCES Localidades(ID)
GO

ALTER TABLE LocalidadesCovenio  WITH CHECK ADD FOREIGN KEY(LocalidadEntregaID)
REFERENCES Localidades(ID)
GO
 
--insert 
INSERT INTO LocalidadesCovenio (ID, LocalidadID, LocalidadEntregaID, Disponible) VALUES
(1, 2, 3, 1),
(2, 2, 4, 1),
(3, 2, 5, 1),
(4, 3, 2, 1),
